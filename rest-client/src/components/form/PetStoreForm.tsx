    ...
    <Modal isOpen={true} onClose={onClose}>
      ...
      <form ref={formRef} onSubmit={handleSubmit} className={styles.form}>
        <div className={styles.inputGroup}>
          <input type="text" name="name" required className={styles.input} placeholder=" " />
          <label className={styles.label}>Name</label>
        </div>

        <div className={styles.inputGroup}>
          <input type="email" name="email" required className={styles.input} placeholder=" " />
          <label className={styles.label}>Email</label>
        </div>

        <div className={styles.inputGroup}>
          <input type="url" name="profileUrl" required className={styles.input} placeholder=" " />
